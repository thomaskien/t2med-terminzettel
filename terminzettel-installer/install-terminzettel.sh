...
if [[ "${1:-}" != "--uninstall" ]]; then
  ...
  apt-get update
  apt-get install -y python3-tomli python3-cups python3-qrcode python3-pil tzdata samba cups-client avahi-daemon poppler-utils ghostscript libgxps-utils tesseract-ocr tesseract-ocr-deu
fi
