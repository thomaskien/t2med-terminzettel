...
Stand: 17. September 2026. Die Software ist für den Gerätetest vorbereitet; eine Produktivfreigabe am Raspberry Pi und Drucker steht noch aus. Alle Testdaten sind künstlich.

## Automatisiert geprüft

- 83 Tests lokal unter Python 3.14: 82 bestanden, ein PostScript-Integrationstest übersprungen, weil das lokal installierte Ghostscript nicht ausführbar ist.
...
- Installer-Konfiguration, Sicherung/Rücknahme bei Dienstfehlern und Schutz nachträglich geänderter Dateien.
...
1. Installation auf dem vorgesehenen Raspberry Pi OS, Neustart und lokaler CUPS-Zugriff auf `TMm10`; RAM ohne Swap und tatsächliche Dienstberechtigungen.
